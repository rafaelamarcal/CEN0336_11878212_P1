...
def main():
    # Checar se o número certo de argumentos foi passado
    if len(sys.argv) != 8:
        print("Uso: digite a sequência do DNA <sequência_DNA> e as coordenadas <n1> <n2> <n3> <n4> <n5> <n6>")
        sys.exit(1)
    ...
    # Tentar converter os índices para inteiros e checar se está tudo certo
    try:
    ...
    # Verificar se algum índice é maior que o tamanho da sequência
